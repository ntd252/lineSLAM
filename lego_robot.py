...
# Orignal Author: Claus Brenner, 28.10.2012
from math import sin, cos, pi

# In previous versions, the S record included the number of scan points. If so, set this to true.
